...
LOG_DIR = "/home/pi/.log/mkv-converter"
RELATIVE_TO_ROOT = "../"
LOG_NAME = "sma.log"
...
def getLogger(name=None, custompath=None):
    if custompath:
        ...
        resourcepath = os.path.normpath(os.path.join(rootpath, RESOURCE_DIR))
        configpath = os.path.normpath(os.path.join(rootpath, CONFIG_DIR))
    else:
